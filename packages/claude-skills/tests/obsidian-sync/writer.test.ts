...
import { upsertNote, upsertTag } from "../../src/obsidian-sync/writer.js";
...
describe("writer (edges)", () => {
  it("linkLinksTo creates a :LINKS_TO edge between two notes", async () => {
    ...
    const { linkLinksTo } = await import("../../src/obsidian-sync/writer.js");
  ...
  it("linkTagged creates a :TAGGED edge from note to tag", async () => {
    const { linkTagged } = await import("../../src/obsidian-sync/writer.js");
